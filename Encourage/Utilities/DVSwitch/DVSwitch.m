...
- (void)layoutSubviews
{
    ...
    self.sliderView.frame = CGRectMake(sliderWidth * self.selectedIndex /*+ self.sliderOffset*/, self.backgroundView.frame.origin.y+self.backgroundView.frame.size.height-self.sliderOffset, sliderWidth /*- self.sliderOffset * 2*/, self.sliderOffset/*self.frame.size.height - self.sliderOffset * 2*/);
...
- (void)animateChangeToIndex:(NSUInteger)selectedIndex
{
    ...
    [UIView animateWithDuration:0.25 delay:0.0 options:UIViewAnimationOptionCurveEaseIn animations:^{
        ...
        CGRect newFrame = CGRectMake(sliderWidth * self.selectedIndex /*+ self.sliderOffset*/, self.backgroundView.frame.origin.y+self.backgroundView.frame.size.height-self.sliderOffset, sliderWidth /*- self.sliderOffset * 2*/, self.sliderOffset/*self.frame.size.height - self.sliderOffset * 2*/);
