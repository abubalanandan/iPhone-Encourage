...
+ (void)initialize
{
	if (self == [ASIHTTPRequest class]) {
		...
		NSString *networkErrorMessage = NSLocalizedString(@"Encourage_Unavailable", nil);
		ASIRequestTimedOutError = [[NSError errorWithDomain:NetworkRequestErrorDomain code:ASIRequestTimedOutErrorType userInfo:[NSDictionary dictionaryWithObjectsAndKeys:networkErrorMessage,NSLocalizedDescriptionKey,nil]] retain];	
		...
		ASIRequestCancelledError = [[NSError errorWithDomain:NetworkRequestErrorDomain code:ASIRequestCancelledErrorType userInfo:[NSDictionary dictionaryWithObjectsAndKeys:networkErrorMessage,NSLocalizedDescriptionKey,nil]] retain];
		...
		ASITooMuchRedirectionError = [[NSError errorWithDomain:NetworkRequestErrorDomain code:ASITooMuchRedirectionErrorType userInfo:[NSDictionary dictionaryWithObjectsAndKeys:networkErrorMessage,NSLocalizedDescriptionKey,nil]] retain];	
...

{
	...
	if (![self error]) { // We may already have handled this error
		...
		NSString *reason =  NSLocalizedString(@"Encourage_Unavailable", @"");
